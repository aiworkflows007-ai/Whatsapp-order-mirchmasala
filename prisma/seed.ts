...
async function main() {
  console.log("🌱 Starting Mirch Masala database seeding...");
  ...
  const menuItems = [
    ...
    // --- Beverages ---
    {
      ...
      description: "A thick, refreshing traditional drink made of whipped thick sweet yoghurt, fresh pulp of Alphonso mangoes, and rose water garnish.",
      price: 95.00,
      isVegetarian: true,
